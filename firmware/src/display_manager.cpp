...
static const uint8_t xbm_wifi[] PROGMEM = {
    0xF0, 0x00, 0xFC, 0x03, 0x0E, 0x07, 0xF3, 0x0C,
    0x39, 0x09, 0x8C, 0x03, 0xC6, 0x06, 0x60, 0x00,
    0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
// cloud: rounded cloud silhouette with two internal drops
static const uint8_t xbm_cloud[] PROGMEM = {
    0x00, 0x00, 0xE0, 0x00, 0xF0, 0x01, 0xFC, 0x03,
    0xFE, 0x07, 0xFF, 0x0F, 0xAB, 0x0A, 0x55, 0x05,
...
static const uint8_t xbm_measure_lg[] PROGMEM = {
    0x00,0x18,0x00, 0x00,0x24,0x00, 0x00,0x24,0x00, 0x00,0x2C,0x00,
    0x00,0x24,0x00, 0x00,0x24,0x00, 0x00,0x2C,0x00, 0x00,0x24,0x00,
    0x00,0x24,0x00, 0x00,0x2C,0x00, 0x00,0x24,0x00, 0x00,0x24,0x00,
    0x00,0x2C,0x00, 0x00,0x24,0x00, 0x00,0x24,0x00, 0x00,0x66,0x00,
    0x00,0x42,0x00, 0x00,0x42,0x00, 0x00,0x42,0x00, 0x00,0x66,0x00,
    0x00,0x3C,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};
// time: clock face — outer ring, small tick marks at 12/3/6/9, centre dot
// with hour and minute hands pointing to ~10:10 (canonical clock pose).
static const uint8_t xbm_time_lg[] PROGMEM = {
    0x00,0x00,0x00, 0x00,0xF0,0x00, 0x00,0x0F,0x03, 0x80,0x01,0x04,
    0x40,0x00,0x08, 0x20,0x00,0x10, 0x10,0x30,0x20, 0x08,0x18,0x40,
    0x08,0x0C,0x40, 0x04,0x06,0x80, 0x84,0x03,0x81, 0x84,0x81,0x81,
    0x04,0xC0,0x80, 0x04,0x40,0x80, 0x08,0x40,0x40, 0x08,0x40,0x40,
    0x10,0x40,0x20, 0x20,0x00,0x10, 0x40,0x00,0x08, 0x80,0x01,0x04,
    0x00,0x0F,0x03, 0x00,0xF0,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};

// led: filled lightbulb with rays.
static const uint8_t xbm_led_lg[] PROGMEM = {
    0x00,0x18,0x00, 0x00,0x18,0x00, 0x22,0x18,0x22, 0x14,0x00,0x14,
    0x00,0xF0,0x00, 0x00,0xFC,0x03, 0x08,0x0E,0x0F, 0x00,0x07,0x1C,
    0x1C,0x03,0x38, 0x00,0x03,0x00, 0x08,0x03,0x08, 0x00,0x03,0x00,
    0x00,0x07,0x00, 0x00,0x0E,0x00, 0x00,0xFC,0x00, 0x00,0x78,0x00,
    0x00,0xF0,0x00, 0x00,0xF0,0x00, 0x00,0x60,0x00, 0x00,0x60,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};

// interval: hourglass with sand
static const uint8_t xbm_interval_lg[] PROGMEM = {
    0x00,0x00,0x00, 0xFF,0xFF,0x0F, 0xFE,0xFF,0x07, 0xFC,0xFF,0x03,
    0xF8,0xFF,0x01, 0xF0,0x7E,0x00, 0xE0,0x3C,0x00, 0xC0,0x18,0x00,
    0x80,0x19,0x00, 0x80,0x19,0x00, 0xC0,0x18,0x00, 0xC0,0x3C,0x00,
    0xE0,0x66,0x00, 0xF0,0xC3,0x00, 0xF8,0x81,0x01, 0xFC,0x81,0x03,
    0xFE,0xC3,0x07, 0xFF,0xE7,0x0F, 0xFF,0xFF,0x0F, 0xFF,0xFF,0x0F,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};

// reset: circular arrow (open circle with arrowhead at top)
static const uint8_t xbm_reset_lg[] PROGMEM = {
    0x00,0x30,0x00, 0x00,0x78,0x00, 0x00,0xFC,0x00, 0xC0,0x1F,0x03,
    ...
    0x30,0x00,0x0C, 0xE0,0x00,0x07, 0xC0,0xFF,0x03, 0x00,0xFF,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};

// sleep: crescent moon + stars
static const uint8_t xbm_sleep_lg[] PROGMEM = {
    0x00,0x00,0x02, 0x00,0xF0,0x07, 0x00,0xFC,0x02, 0xC0,0xFF,0x00,
    0xE0,0x7F,0x08, 0xF0,0x3F,0x1C, 0xF8,0x07,0x08, 0xFC,0x03,0x00,
    0xFC,0x01,0x00, 0xFE,0x01,0x02, 0xFE,0x01,0x07, 0xFE,0x01,0x02,
    0xFC,0x01,0x00, 0xFC,0x03,0x00, 0xF8,0x07,0x00, 0xF0,0x3F,0x00,
    0xE0,0x7F,0x00, 0xC0,0xFF,0x00, 0x00,0xFC,0x00, 0x00,0xE0,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};

// weather: sun with cloud (unchanged)
static const uint8_t xbm_weather_lg[] PROGMEM = {
    0x00,0x30,0x00, 0x22,0x30,0x22, 0x14,0x00,0x14, 0x00,0xF0,0x00,
    0x00,0xFC,0x03, 0x00,0x0E,0x07, 0x00,0x03,0x0C, 0x7F,0x01,0x08,
    0x80,0x01,0x08, 0x40,0x00,0x08, 0x40,0x00,0x08, 0x40,0x00,0x08,
    0x80,0x03,0x08, 0x00,0x1C,0x0C, 0x00,0x60,0x07, 0x00,0x80,0x01,
    0x00,0x40,0x00, 0x00,0x20,0x00, 0x00,0x10,0x00, 0x00,0x00,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};
// locate: map pin
static const uint8_t xbm_locate_lg[] PROGMEM = {
    0x00,0xF0,0x00, 0x00,0xFC,0x03, 0x00,0x1E,0x07, 0x00,0x07,0x0C,
    0x80,0x03,0x0C, 0x80,0x01,0x08, 0x80,0x01,0x08, 0x80,0xF9,0x09,
    0x80,0x05,0x0A, 0x80,0x05,0x0A, 0x80,0xF9,0x09, 0x80,0x01,0x08,
    0x80,0x03,0x08, 0x00,0x03,0x0C, 0x00,0x0E,0x07, 0x00,0x18,0x03,
    0x00,0x70,0x01, 0x00,0xE0,0x00, 0x00,0x40,0x00, 0x00,0x00,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};
// stats: bar chart
static const uint8_t xbm_stats_lg[] PROGMEM = {
    0x00,0x00,0x00, 0x00,0x00,0x08, 0x00,0x00,0x08, 0x00,0x00,0x08,
    0x00,0x00,0x08, 0x00,0x00,0x0A, 0x00,0x00,0x0A, 0x00,0x00,0x0A,
    0x00,0x40,0x0A, 0x00,0x40,0x0A, 0x00,0x40,0x0A, 0x00,0x40,0x0A,
    0x00,0x50,0x0A, 0x00,0x50,0x0A, 0x00,0x50,0x0A, 0x00,0x54,0x0A,
    0x00,0x54,0x0A, 0x00,0x54,0x0A, 0x00,0x54,0x0A, 0xFF,0xFF,0x0F,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};
...
static const uint8_t xbm_wifimenu_lg[] PROGMEM = {
    ...
    0xF0,0x00,0x0F, 0x18,0x00,0x18, 0x0C,0xFF,0x30, 0x84,0xFF,0x21,
    0xE0,0x00,0x07, 0x30,0x00,0x0C, 0x10,0x7E,0x08, 0x00,0xFF,0x00,
    0x80,0x81,0x01, 0xC0,0x00,0x03, 0x00,0x3C,0x00, 0x00,0x66,0x00,
    0x00,0x42,0x00, 0x00,0x66,0x00, 0x00,0x3C,0x00, 0x00,0x00,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};
// portal (wifi cog)
static const uint8_t xbm_portal_lg[] PROGMEM = {
    0x00,0x18,0x00, 0x40,0x18,0x02, 0x80,0x3C,0x01, 0x00,0xFF,0x00,
    0x80,0xFF,0x01, 0xC0,0xE7,0x03, 0xE0,0xC3,0x07, 0xF0,0x81,0x0F,
    0x30,0x81,0x0C, 0x1F,0x00,0xF8, 0x1F,0x00,0xF8, 0x30,0x81,0x0C,
    0xF0,0x81,0x0F, 0xE0,0xC3,0x07, 0xC0,0xE7,0x03, 0x80,0xFF,0x01,
    0x00,0xFF,0x00, 0x80,0x3C,0x01, 0x40,0x18,0x02, 0x00,0x18,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};
// clear (trash can)
static const uint8_t xbm_clear_lg[] PROGMEM = {
    0x00,0xFC,0x00, 0x00,0x03,0x03, 0xF0,0xFF,0x0F, 0x00,0x00,0x00,
    0x00,0xF0,0x00, 0x00,0xF0,0x00, 0x40,0xF2,0x02, 0x40,0xF2,0x02,
    0x40,0xF2,0x02, 0x40,0xF2,0x02, 0x40,0xF2,0x02, 0x40,0xF2,0x02,
    0x40,0xF2,0x02, 0x40,0xF2,0x02, 0x40,0xF2,0x02, 0x40,0xF2,0x02,
    0x40,0xF2,0x02, 0x80,0xF1,0x01, 0x00,0xFF,0x00, 0x00,0x00,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};
// select (checkmark)
static const uint8_t xbm_select_lg[] PROGMEM = {
    0x00,0x00,0x00, 0x00,0x00,0x08, 0x00,0x00,0x0C, 0x00,0x00,0x0E,
    0x00,0x00,0x07, 0x00,0x80,0x03, 0x00,0xC0,0x01, 0x00,0xE0,0x00,
    0x00,0x70,0x00, 0x0F,0x38,0x00, 0x0E,0x1C,0x00, 0x1C,0x0E,0x00,
    0x38,0x07,0x00, 0xF0,0x03,0x00, 0xE0,0x01,0x00, 0xC0,0x00,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
    0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00, 0x00,0x00,0x00,
};
// back (arrow left)
